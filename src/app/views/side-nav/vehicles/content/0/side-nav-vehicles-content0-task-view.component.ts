...
@Component({
  selector: 'app-side-nav-vehicles-content0-task-view',
  templateUrl: './side-nav-vehicles-content0-task-view.component.html',
  styleUrls: ['./side-nav-vehicles-content0-task-view.component.scss'],
  providers: [
    CategoryFactory,
    TaskViewService,
    SearchService,
...
export class SideNavVehiclesContent0TaskViewComponent extends TabbedTaskView implements AfterViewInit {
