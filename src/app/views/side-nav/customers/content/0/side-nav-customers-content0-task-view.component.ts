...
@Component({
  selector: 'app-side-nav-customers-content0-task-view',
  templateUrl: './side-nav-customers-content0-task-view.component.html',
  styleUrls: ['./side-nav-customers-content0-task-view.component.scss'],
  providers: [
    CategoryFactory,
    TaskViewService,
    SearchService,
...
export class SideNavCustomersContent0TaskViewComponent extends TabbedTaskView implements AfterViewInit {
