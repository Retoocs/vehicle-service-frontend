...
@Component({
  selector: 'app-side-nav-warehouses-content0-task-view',
  templateUrl: './side-nav-warehouses-content0-task-view.component.html',
  styleUrls: ['./side-nav-warehouses-content0-task-view.component.scss'],
  providers: [
    CategoryFactory,
    TaskViewService,
    SearchService,
...
export class SideNavWarehousesContent0TaskViewComponent extends TabbedTaskView implements AfterViewInit {
