...
@Component({
  selector: 'app-side-nav-requests-content1-case-view',
  templateUrl: './side-nav-requests-content1-case-view.component.html',
  styleUrls: ['./side-nav-requests-content1-case-view.component.scss'],
  providers: [
    CategoryFactory,
    CaseViewService,
    SearchService,
    {
      provide: NAE_DEFAULT_HEADERS, useValue: [
        'meta-title',
        'repair-public_company_name',
        'repair-public_name',
        'repair-public_surname',
        'meta-creationDate'
      ]
    },
    {
...
export class SideNavRequestsContent1CaseViewComponent extends TabbedCaseView implements AfterViewInit {
