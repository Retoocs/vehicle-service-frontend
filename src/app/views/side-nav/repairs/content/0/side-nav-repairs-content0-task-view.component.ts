...
@Component({
  selector: 'app-side-nav-repairs-content0-task-view',
  templateUrl: './side-nav-repairs-content0-task-view.component.html',
  styleUrls: ['./side-nav-repairs-content0-task-view.component.scss'],
  providers: [
    CategoryFactory,
    TaskViewService,
    SearchService,
...
export class SideNavRepairsContent0TaskViewComponent extends TabbedTaskView implements AfterViewInit {
